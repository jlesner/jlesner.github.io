...
{DBDoctor: LLM-Aided SMT Refutation}
  ...
  \vspace{0.4em}
  \CVEntry
    {GUARD: Guided Explanations for Ambiguous Human–AI Dialogue}
    {UCSB}
    {Advisor: Dr. Misha Sra}
    {Fall 2024}
  \begin{itemize}
    \item Prototyped a mobile-first ``Guided Understanding'' interface that surfaces ambiguities, hedging, and conflicting commitments in real-time spoken and written communication.
