...
If I continued this on this prototype, the next step would be to extend the prototype with adapters to read documents and record conversations and to interface with AI tools to organize and analyze these inputs and offer targeted recommendations. 
   ...
   What artifacts were created? papers, posters, demos, code releases, internal reports?
    4. Prototype demo available to the public at https://memoir.ackop.com/index7.html and a user study paper about the prototype attached below
    
    
WRITEUP about the evaulation of GUARD Prototype
