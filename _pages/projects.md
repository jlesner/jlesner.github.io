...
<!-- <div class="projects"> -->
  ...
  <div class="project-container" style="display: flex; gap: 2rem; margin-bottom: 2rem; align-items: center;">
    <div class="project-content" style="flex: 1; max-width: 90%;">
      ...
      <p>Can <a href="#">OpenAI's embeddings</a> augment <a href="#">USDA's National Food Nutrient Database</a>? 
      Yes! 
      ...
      <!-- <p>These questions and others are investigated.</p> -->
      <!-- <div class="project-links" style="margin-top: 1.5rem; display: flex; gap: 1rem; flex-wrap: wrap;">
    ...
    <div class="project-image" style="flex: 1; max-width: 50%;">
      <a href="../images/betterfoodgroups.png" target="_blank">  
        <img src="../images/betterfoodgroups.png" alt="Illustration of better food groups" style="width: 100%; height: auto;">
      </a>
    </div>
  </div>
  ...
  <div class="project-container" style="display: flex; gap: 2rem; margin-bottom: 2rem; align-items: center;">
    <div class="project-content" style="flex: 1; max-width: 90%;">
      ...
      <p>Can generative AI be used to create personalized interactive stories for young children?
        Yes! 
