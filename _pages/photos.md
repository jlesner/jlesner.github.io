...
<div class="gallery" >
    ...
    <h1 id="bikex" style="text-align: center; margin-bottom: 2rem;"><a href="https://bikex.org/" target="_blank">Silicon Valley Bike Exchange</a></h1>
    <div class="gallery-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 1rem; padding: 0 1rem;">
        <div class="project-image" >
            <a href="https://jlesner0.ackop.com/svbikex/PXL_20251119_214648283.jpg" target="_blank">
                <img src="https://jlesner0.ackop.com/svbikex/PXL_20251119_214648283.jpg" alt="" style="width: 100%; height: auto;">
            </a>
        </div>
        <!-- <div class="project-image" >
        ...
        <div class="project-image" >
            <a href="https://jlesner0.ackop.com/svbikex/1254964174c.jpg" target="_blank">
                <img src="https://jlesner0.ackop.com/svbikex/1254964174c.jpg" alt="" style="width: 100%; height: auto;">
            </a>
        </div>
    </div>
    <hr style="height: 5px; background-color: black; border: none;">
    <h1 id="sbhacks25" style="text-align: center; margin-bottom: 2rem;"><a href="https://sb-hacks-xi.devpost.com/" target="_blank">SB Hacks XI</a> (Santa Barbara, 2025)</h1>
    <div class="gallery-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 1rem; padding: 0 1rem;">
        <!-- <div class="project-image" >
    ...
    <hr style="height: 5px; background-color: black; border: none;">
    <h1 id="paliving" style="text-align: center; margin-bottom: 2rem;">My Living Room (Palo Alto ~2016)</h1>
    <iframe 
        width="560" 
        height="315" 
